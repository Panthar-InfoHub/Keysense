...
export const getName = async () => {
    try {
        ...
        if (!token) {
            return parseServerResponse({ status: 'FAIL' , message : "Login to access Data" })
        }
        ...
        return parseServerResponse({ status: 'FAIL' })
    }
}

export const getHotelName = async (hotelId, token) => {
    try {
