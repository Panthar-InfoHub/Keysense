...
const sendWhatsAppMessage = async (reservationId, phoneNumber, guestName, checkIn, checkOut) => {
    try {
        ...
        console.log("🔑 AI Sensy API Key Loaded");
        ...
        const messageText = `*Reservation Details*\n\nHello *${guestName}*,\n\nThank you for making your reservation.\n\nHere are your reservation details:\n\n*Reservation ID:* ${reservationId}\n*Name:* ${guestName}\n*Phone Number:* ${phoneNumber}\n*Check-In:* ${formattedCheckIn}\n*Check-Out:* ${formattedCheckOut}\n\nYou can access your dashboard using the following link:\n${reservationDashboardUrl}\n\n*Regards,*\nThe Keysense Team\nkeysense.co.in`;
